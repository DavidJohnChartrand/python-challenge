...
# Created a function that creates a list that is composed of the difference in the imputed array
def Diff_array(arra):
...
with open(budget_data_path) as budget_csv:
    ...
    # And append the Profits/losses and dates to the appropriate list
